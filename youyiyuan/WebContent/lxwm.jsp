...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>游弋苑-联系我们</title>
<link href="css/font-awesome.css" rel="stylesheet">
<link href="css/header.css" type="text/css" rel="stylesheet">
<link href="css/lxwm.css" type="text/css" rel="stylesheet">
...
<body>
	...
	<div class="conbox">
		<ul class="lxfs">
			<li><img src="images/lxwm/phone.png"></li>
			<li><img src="images/lxwm/ren.png"></li>
			<li><img src="images/lxwm/emall.png"></li>
			<li><img src="images/lxwm/qq.png"></li>
		</ul>
		<ul class="lxxq">
			<li>联系木地</li>
			<li>传真：0755-7268668（营销部）</li>
			<li>传真：0755-7768678（服务部）</li>
			<li>地址：珠海市金湾区红旗镇木地酒庄</li>
			<li>邮编：4245112</li>
			<li>邮箱：1787718318@qq.com</li>
			<li>官网：www.mdjz.com</li>
		</ul>
		<div>
			<img src="images/lxwm/ditu.jpg">
		</div>
		<div class="lyb">
			<p>
				建议我们<br> <small>如果您有任何意见或建议，请给我们留言，我们会在一个工作日内回复您！</small>
			</p>
			<ul class="lxbd">
